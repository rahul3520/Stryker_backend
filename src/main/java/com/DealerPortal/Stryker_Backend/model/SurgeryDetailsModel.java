...
public class SurgeryDetailsModel {
    ...
    public SurgeryDetailsModel() {
    }

    public SurgeryDetailsModel(int id, String ticketId, String surgeryName, String duration, Date date, int itemsOrdered, String priority, String status, String assignedAgent, String doctorList, String hospitalName) {
        this.id = id;
